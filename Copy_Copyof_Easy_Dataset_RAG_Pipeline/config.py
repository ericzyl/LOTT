...
SAVE_DATA_DIR = PROJECT_ROOT / "Copy_Copyof_Easy_Dataset_RAG_Pipeline/data"
MODELS_DIR = PROJECT_ROOT / "Copy_Copyof_Easy_Dataset_RAG_Pipeline/models"
EMBEDDINGS_DIR = PROJECT_ROOT / "Copy_Copyof_Easy_Dataset_RAG_Pipeline/embeddings"
RESULTS_DIR = PROJECT_ROOT / "Copy_Copyof_Easy_Dataset_RAG_Pipeline/results"
FAISS_INDEX_DIR = PROJECT_ROOT / "Copy_Copyof_Easy_Dataset_RAG_Pipeline/faiss_indices"
...
LDA_ITERATIONS = 500  # Reduced from 1500 (MS MARCO has shorter docs)
LDA_RANDOM_STATE = 42
